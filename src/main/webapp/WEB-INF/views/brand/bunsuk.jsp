	...
	<c:if test="${mode != 'gamaeng'}">
      ...
      <symbol id="sun-fill" viewBox="0 0 16 16">
		...
		<script type="text/javascript">
			function popUp() {
				window.open("brandform.do", "BrandForm",
			...
			<div style="justify-content: flex-end !important;" class="text-start">
				...
				<p>
					<a href="bunsuk_do"
						...
						href="bunsuk_do?tablename=chicken"
						style="font-size: 15px; text-decoration: none; color: white;"
						class="btn btn-primary my-2">치킨</a>&nbsp; <a
						href="bunsuk_do?tablename=pizza"
						style="font-size: 15px; text-decoration: none; color: white;"
						class="btn btn-primary my-2">피자</a>&nbsp; <a
						href="bunsuk_do?tablename=jokbal_Bossam"
						style="font-size: 15px; text-decoration: none; color: white;"
						class="btn btn-primary my-2">족발/보쌈</a>&nbsp; <a
						href="bunsuk_do?tablename=japanese"
						style="font-size: 15px; text-decoration: none; color: white;"
						class="btn btn-primary my-2">일식</a>&nbsp; <a
						href="bunsuk_do?tablename=chinese"
						style="font-size: 15px; text-decoration: none; color: white;"
						class="btn btn-primary my-2">중식</a>&nbsp; <a
						href="bunsuk_do?tablename=korean"
						style="font-size: 15px; text-decoration: none; color: white;"
						class="btn btn-primary my-2">한식</a>&nbsp; <a
						href="bunsuk_do?tablename=western"
						style="font-size: 15px; text-decoration: none; color: white;"
						class="btn btn-primary my-2">양식</a>&nbsp; <a
						href="bunsuk_do?tablename=snack"
						style="font-size: 15px; text-decoration: none; color: white;"
						class="btn btn-primary my-2">분식</a>&nbsp; <a
						href="bunsuk_do?tablename=pub"
						style="font-size: 15px; text-decoration: none; color: white;"
						class="btn btn-primary my-2">주점</a>&nbsp; <a
						href="bunsuk_do?tablename=fastFood"
						style="font-size: 15px; text-decoration: none; color: white;"
						class="btn btn-primary my-2">패스트푸드</a>&nbsp; <a
						href="bunsuk_do?tablename=asian"
						style="font-size: 15px; text-decoration: none; color: white;"
						class="btn btn-primary my-2">아시안</a>&nbsp; <a
						href="bunsuk_do?tablename=dessert"
						style="font-size: 15px; text-decoration: none; color: white;"
						class="btn btn-primary my-2">디저트</a>&nbsp; <a
						href="bunsuk_do?tablename=cafe"
						style="font-size: 15px; text-decoration: none; color: white;"
		...
		<div style="padding: 300px;"
			...
			<c:if test="${not empty tablename}">
				<button style="font-size: 13px;"
					onclick="window.location='bunsuk_do?tablename=${tablename}'"
					class="btn btn-light rounded-pill px-3" type="button">기본순</button>
			</c:if>

			<c:if test="${empty tablename}">
				<button style="font-size: 13px;"
					onclick="window.location='bunsuk_do?sortBy=1'"
					class="btn btn-light rounded-pill px-3" type="button">창업
					비용 높은 순</button>
			</c:if>
			<c:if test="${not empty tablename}">
				<button style="font-size: 13px;"
					onclick="window.location='bunsuk_do?sortBy=1&tablename=${tablename}'"
					class="btn btn-light rounded-pill px-3" type="button">창업
					비용 높은 순</button>
			</c:if>
		</div>
							...
							<div class="card shadow-sm">
								...
								<div class="card-body">
									...
									<div class="css-1hqidh4">
										...
										&nbsp;
										<p class="css-1nybzwc">
											<fmt:formatNumber value="${dto.total}" pattern="###,###" />
										</p>
									</div>
									<div class="css-1hqidh4">
					...
					<div class="pagination">
						<c:if test="${count > 0}">
							...
							<c:forEach var="i" begin="${startPage}" end="${endPage}">
								<c:url var="pageNumber"
									value="bunsuk_do?tablename=${tablename }">
